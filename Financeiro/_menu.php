...
<nav class="navbar-default navbar-side" role="navigation">
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            ...
            <li>
                <a href="#"><i class="fa fa-money" style="font-size:36px"></i> Conta<span class="fa arrow"></span></a>
                <ul class="nav nav-second-level">
                    <li>
            ...
            <li>
             <a href="_menu.php?close=1"><i class="fa fa-power-off" style="font-size:36px"></i> Sair</a>  
            </li>
        </ul>
